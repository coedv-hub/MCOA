...
function [Silverback_Score,Silverback,convergence_curve]=GTO(pop_size,max_iter,lower_bound,upper_bound,variables_no,fobj,G)
...
%% Exploitation:  
    ...
    Silverback = LocalSearch(Silverback,upper_bound,G);
